package com.qxb.common.utils.file;
...
import com.qxb.common.exception.file.FileNameLengthLimitExceededException;
import com.qxb.common.exception.file.FileSizeLimitExceededException;
import com.qxb.common.exception.file.InvalidExtensionException;
import com.qxb.common.utils.DateUtils;
import com.qxb.common.utils.StringUtils;
import com.qxb.common.utils.uuid.IdUtils;
import com.qxb.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = QxbConfig.getProfile();
    ...
    {
        int dirLastIndex = QxbConfig.getProfile().length() + 1;
